...
<html lang="fr">
  <head>
    ...
    <link rel="stylesheet" href="https://meyerweb.com/eric/tools/css/reset/reset.css?v=1.000">
    <link rel="stylesheet" href="css/back.css?v=1.722">
    ...
    <link rel="stylesheet" href="css/safari.css?v=1.001">
  </head>
  <body ondragstart="return false;" ondrop="return false;">
    <div id="screen">
      ...
      <div id="workspace" class="spacemodal">
        ...
        <div id="mainmenu" class="elemcb" style="display: block;">
          <div class="modal-content-mainmenu modal-content-cb">
            <form method="post" action="valid.php">
              <div class="modal-header-mainmenu modal-header-cb">
                <img id='logopbid' src='img/LOGO_PRATIC_BOUTIC.png' alt="">
              ...
              <div class="modal-body-mainmenu modal-body-cb">
                <div class="form-group enlarged">
                  <input class="form-control" placeholder="Courriel" type="text" id="emailid" name="email">
                </div>
                <div class="form-group enlarged">
        ...
        <img id='illus1' src='img/illustration_1.png' class='elemcb epure' alt="">
      </div>
