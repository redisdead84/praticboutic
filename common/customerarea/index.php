        ...
        <div class="modal-content">
          <form method="post" action="valid.php">
            ...
            <div class="modal-footer">
              <input class="btn btn-primary btn-block" type="submit" value="Valider"><br>
              <a class="mr-auto mdfaddlink" href="./password.php">Mot de passe oublié ?</a><br>
              <a class="mr-auto mdfaddlink" href="./reg.php">Je crée ma boutic</a>
            </div>
          </form>
        </div>
      </div>
