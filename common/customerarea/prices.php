            ...
            <main id="mainid" class="fcb">
              <div id="cfid" class="customform">
                ...
                <div class="formulespace">
                  <img id="commissionico" class="formuleico" src="img/commission_unselected.png?v=0.2" onclick="toggle(this)" data-state="off" alt="">
                  <img id="engagementico" class="formuleico" src="img/engagement_unselected.png?v=0.2" onclick="toggle(this)" data-state="off" alt="">
                </div>
                <div class="param rwc centerable">
                  <input type="checkbox" id="cgvid" name="cgv" value="on" onclick="allow()">
                  <label class="grey" for="cgv">J'accepte <a class="greylink" href="javascript:bakinfo();window.location='cgv.php'"><u>les conditions générales de vente</u></a></label>
                </div>
                <div class="param rwc">
